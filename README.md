...
This is an unofficial Mac port of Teenage Mutant Ninja Turtles: Shredder's Revenge. It is based on [JohnnyOnFlame](https://ko-fi.com/johnnyonflame)'s port for [Portmaster](https://github.com/PortsMaster/PortMaster-New), using [FNA](https://fna-xna.github.io/) and [mono](https://gitlab.winehq.org/mono/mono) to run the game.
...
1. Make sure Steam is running, then click this link [steam://open/console](steam://open/console).
